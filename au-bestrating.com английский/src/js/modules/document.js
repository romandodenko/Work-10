...
const footerTopBottom = document.querySelector(".footer__top-bottom");

const support = document.querySelector(".support");

const cookieLinks = document.querySelector('.cookie__links');

const navListFooter = document.querySelector(".nav__list_footer");

if (footer) {
  if (document.body.clientWidth < 992) {
    footerTopBottom.append(support);
    cookieLinks.append(navListFooter);
  }
}