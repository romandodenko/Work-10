...
if (header) {
  ...
  if (heroContainer) {
    heroContainer.style.paddingTop = (headerHeight + 62) + "px";
  }

  if (slotsContainer) {
    slotsContainer.style.paddingTop = (headerHeight + 62) + "px";
  }
}

const navFooter = document.querySelector(".nav_footer");

const contianerFooter = document.querySelector(".footer__container");

if (navFooter && contianerFooter) {

  if (document.body.clientWidth < 601) {
    contianerFooter.append(navFooter);
  }
}
// };