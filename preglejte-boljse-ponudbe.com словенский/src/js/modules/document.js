...
const slotsTop = document.querySelector('.slots_top');
...
if (header) {
  ...
  if (heroContainer) {
    heroContainer.style.paddingTop = (headerHeight + 100) + "px";
  }

  if (slotsTop) {
    slotsTop.style.paddingTop = (headerHeight + 62) + "px";
  }
  
  if (terms) {
    terms.style.paddingTop = (headerHeight + 62) + "px";
  }

  if (contacts) {
    contacts.style.paddingTop = (headerHeight + 62) + "px";
  }
}