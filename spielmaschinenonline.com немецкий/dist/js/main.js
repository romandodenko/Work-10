...
const spielregelnItems = document.querySelectorAll(".spielregeln__item");

if (spielregelnItems) {
  spielregelnItems.forEach(function (e, i) {
    let num = e.querySelector(".spielregeln__num");
    num.innerHTML = (i + 1);
  })
}

const geschichteImages = document.querySelector(".geschichte__images");

const geschichteImageOne = document.querySelector(".geschichte__image_1");

if (geschichteImages && geschichteImageOne) {
  if (document.body.clientWidth < 992) {
    geschichteImages.append(geschichteImageOne);
  }
}
// };