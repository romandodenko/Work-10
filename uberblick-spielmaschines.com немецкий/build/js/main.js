...
if (footerTop && footerBottom) {
  ...
  if (document.body.clientWidth < 992) {
    if (footerWar) {
      footerBottom.append(footerWar);
    }
    if (support) {
      footerTop.append(support);
    }
  }
}

const unterSlider = document.querySelector(".unter-slider");

if(unterSlider) {
  const unterSwiper = new Swiper(unterSlider, { 
    observer: true,
    observeParents: true,
    watchOverflow: true,
    slidesPerView: 'auto',
